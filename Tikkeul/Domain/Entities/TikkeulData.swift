...
extension TikkeulData {
    static let dummyData: [TikkeulData] = {
        ...
        let thisMonth = calendar.date(byAdding: .month, value: 0, to: now)!
        let lastMonth = calendar.date(byAdding: .month, value: -1, to: now)!

        return [
            // 이번 주 데이터
            TikkeulData(id: UUID(), money: 5000, category: "coffee", date: calendar.date(byAdding: .day, value: -1, to: thisWeek)!),
            TikkeulData(id: UUID(), money: 12000, category: "delivery", date: calendar.date(byAdding: .day, value: -3, to: thisWeek)!),
            TikkeulData(id: UUID(), money: 15000, category: "drink", date: thisWeek, memo: "Weekend Drinks"),
            TikkeulData(id: UUID(), money: 7000, category: "beauty", date: calendar.date(byAdding: .day, value: -2, to: thisWeek)!),
            ...
            // 이번 달 데이터
            TikkeulData(id: UUID(), money: 9000, category: "coffee", date: calendar.date(byAdding: .day, value: -10, to: thisMonth)!),
            TikkeulData(id: UUID(), money: 3000, category: "delivery", date: calendar.date(byAdding: .day, value: -12, to: thisMonth)!),
            TikkeulData(id: UUID(), money: 5000, category: "drink", date: calendar.date(byAdding: .day, value: -5, to: thisMonth)!, memo: "Friends Meetup"),
            TikkeulData(id: UUID(), money: 6000, category: "beauty", date: calendar.date(byAdding: .day, value: -7, to: thisMonth)!),
